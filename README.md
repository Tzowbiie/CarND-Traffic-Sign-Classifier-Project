...
* Load the data set (see below for links to the project data set using the [German Traffic Sign Dataset](http://benchmark.ini.rub.de/?section=gtsrb&subsection=dataset) )
...
Here is a link to my [project code](https://github.com/Tzowbiie/CarND-Traffic-Sign-Classifier-Project/blob/master/Traffic_Sign_Classifier.ipynb)
